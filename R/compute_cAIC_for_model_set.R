#' Compute cAIC for different models
#'
...
#' @param X_cluster_full Matrix with cluster level covariates
...
#'
#' @details
#' * \code{model}  - for the moment, only NERM is supported
#' * \code{covariate_selection_matrix} - necessary only if \code{modelset = NULL}
#'
...
compute_cAIC_for_model_set = function(X,
                                      y,
                                      clusterID,
                                      X_cluster_full = NULL,
                                      model = "NERM",
