...
#' @param var_cov_terms Variance and covariance terms in each model (appropriate elements from matrix Sigma)
...
construct_constraints <- function(degcAIC_models, cAIC_min,
                                  var_cov_terms, p) {
