...
In what follows, we use abbreviaiton CRS-2021 to refer to Claeskens, Reluga, and Sperlich (2021).
...
To compare the performance of post-cAIC CI, we construct naive CI which do not take the model selection step into account. In addition, we construct post-OBSP CI of Sugasawa, S., Kawakubo, Y. and Datta, G. S. (2019) for mixed parameters and plot them together.
